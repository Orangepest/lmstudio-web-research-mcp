...
- Director autopilot recovery/status: autopilot can run `policy=balanced|aggressive` recovery before each iteration, and `action: autopilot_status|autopilots` loads prior autonomy ledgers without opening files
